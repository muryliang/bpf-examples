...
if [ "x$1" == "xxdp" ]; then
    ...
    (cd ../xdp-tutorial/cpass; ip netns exec ns1 ./xdp_pass_user --dev e12)  &
if [ "x$2" == "xaf" ]; then
    (cd cafwd; ip netns exec ns2 ./xskfwd -i e21 -q 0 -i e23 -q 0 -c 2 ) &
...
#    ip netns exec ns2 ./af_go/afgo -from e23 -to e21  &
    ...
    (cd ../xdp-tutorial/cfwd; ip netns exec ns2 ./xdp-loader load -p /etc/bpf/e21 -n xdp_fwd_direct_prog e21 xdp_prog_kern.o)
    (cd ../xdp-tutorial/cfwd; ip netns exec ns2 ./xdp_prog_user -d e21 -r e23)
    (cd ../xdp-tutorial/cfwd; ip netns exec ns2 ./xdp-loader load -p /etc/bpf/e23 -n xdp_fwd_direct_prog e23 xdp_prog_kern.o)
    (cd ../xdp-tutorial/cfwd; ip netns exec ns2 ./xdp_prog_user -d e23 -r e21)
fi
...
# for test from ns3 to ns1
    ...
    (cd ../xdp-tutorial/cpass; ip netns exec ns3 ./xdp_pass_user --dev e32)  &
